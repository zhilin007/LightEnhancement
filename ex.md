...
|Res18Net1 `dims=[16,24,32,48,64]不能收敛，[32,64,64,64,64]下：`|1e5||||python train_tensorboard.py --net=Res18Net1 --step=100000 --device=cuda:0 --pth=Res18Net1_384p_1e5_l1 --divisor=16 --bs=8 --l1loss --crop_size=384|
