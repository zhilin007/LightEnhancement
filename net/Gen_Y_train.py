...
def train(net,loader_train,loader_test,optim_y,optim_net,criterion):
	losses=[]
	start_step=0
	max_ssim=0
	max_psnr=0
...
if __name__ == "__main__":
	...
	optimizer_net=RAdam(params=filter(lambda x: x.requires_grad,net.module.unet.parameters()),lr=opt.lr,betas = (0.9, 0.999), eps=1e-08)
	optimizer_net.zero_grad()
	train(net,loader_train,loader_test,optimizer_y,optimizer_net,criterion)
